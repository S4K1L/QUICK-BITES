...
class UserForgotScreen extends StatefulWidget {
  const UserForgotScreen({super.key});

  @override
  State<UserForgotScreen> createState() => _UserForgotScreenState();
}

class _UserForgotScreenState extends State<UserForgotScreen> {

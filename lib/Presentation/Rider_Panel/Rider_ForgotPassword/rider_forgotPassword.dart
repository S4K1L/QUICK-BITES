...
class RiderForgotScreen extends StatefulWidget {
  const RiderForgotScreen({super.key});

  @override
  State<RiderForgotScreen> createState() => _RiderForgotScreenState();
}

class _RiderForgotScreenState extends State<RiderForgotScreen> {
